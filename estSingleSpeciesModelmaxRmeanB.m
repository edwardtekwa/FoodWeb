function [r,a,z,K,flag,raR2,r_T,K_T,K_T_ratio,r_T_ratio]=estSingleSpeciesModelmaxRmeanB(Btrans,dBtrans,gainBtrans,P,fitCode) %r, a dimensions: species, patch (temperature)
